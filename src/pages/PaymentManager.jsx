...
const AdminPaymentPanel = () => {
  ...
  const getPurchaseItemName = (purchase) => {
    if (purchase.course) return purchase.course.name;
    if (purchase.audioLecture) return purchase.audioLecture.name;
    if (purchase.studyMaterial) return purchase.studyMaterial.name;
    if (purchase.mcqTest) return purchase.mcqTest.name;
    if (purchase.unit) return purchase.unit.name;
    return 'N/A';
  };
