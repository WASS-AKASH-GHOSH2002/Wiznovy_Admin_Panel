...
const NoticeBoardManager = () => {
  ...
  const fetchNotices = async () => {
    ...
    try {
      ...
      // dispatch(addAuditLog("NOTICES_FETCHED", "NOTICE_BOARD", {
      ...
      setLoading(false);
      // dispatch(addAuditLog("NOTICE_FETCH_ERROR", "NOTICE_BOARD", { error: err.message }));
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // dispatch(addAuditLog("NOTICE_CREATED", "NOTICE_BOARD", { fileName: file.name }));
      setFile(null);
      e.target.reset();
      fetchNotices();
    } catch (err) {
      console.error("Failed to create notice:", err);
      // dispatch(addAuditLog("NOTICE_CREATION_ERROR", "NOTICE_BOARD", {
      //   error: err.message,
      //   fileName: file.name,
      // }));
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this notice?")) {
      try {
        ...
        // dispatch(addAuditLog("NOTICE_DELETED", "NOTICE_BOARD", { noticeId: id }));
        fetchNotices();
      } catch (err) {
        console.error("Failed to delete notice:", err);
        // dispatch(addAuditLog("NOTICE_DELETION_ERROR", "NOTICE_BOARD", {
        //   noticeId: id,
        //   error: err.message,
        // }));
  ...
  const handleToggleStatus = async (id, currentStatus) => {
    ...
    try {
      ...
      // dispatch(addAuditLog("NOTICE_STATUS_UPDATED", "NOTICE_BOARD", {
      //   noticeId: id,
      //   newStatus: newStatus,
      // }));
      fetchNotices();
      ...
      // dispatch(addAuditLog("NOTICE_STATUS_UPDATE_ERROR", "NOTICE_BOARD", {
      //   noticeId: id,
      //   error: err.message,
      // }));
  ...
  const handleUpdateNotice = async (e, id) => {
    ...
    try {
      ...
      // dispatch(addAuditLog("NOTICE_UPDATED", "NOTICE_BOARD", {
      //   noticeId: id,
      //   fileName: file.name,
      // }));
      setFile(null);
      ...
      // dispatch(addAuditLog("NOTICE_UPDATE_ERROR", "NOTICE_BOARD", {
      //   noticeId: id,
      //   error: err.message,
      // }));
