...
const GoalManager = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
                ...
                <tr key={goal.id} className={index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                  ...
                  <td className="p-2 sm:p-4">
                    <div className="flex gap-1">
                      <ActionButton onClick={() => handleEdit(goal)} className="text-blue-600 hover:text-blue-800 p-1" title="Edit Goal">
                        <Edit size={16} />
                      </ActionButton>
                      <ActionButton onClick={() => handleStatusUpdate(goal)} className="text-green-600 hover:text-green-800 p-1" title="Update Status">
                        <Settings size={16} />
                      </ActionButton>
                      <ActionButton onClick={() => handleDelete(goal.id)} className="text-red-600 hover:text-red-800 p-1" title="Delete Goal">
                        <Trash2 size={16} />
                      </ActionButton>
                    </div>
                  </td>
      ...
      <Modal isOpen={showForm} title={editingId ? 'Edit Goal' : 'Add New Goal'}>
      ...
      <Modal isOpen={showStatusModal && statusUpdateGoal} title="Update Goal Status">
